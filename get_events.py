...
class EventsFetcher:
    ...
    def get_events(self, city: str = 'Sydney', days_ahead: int = 30, limit: int = 15) -> List[Dict[str, Any]]:
...
events_fetcher = EventsFetcher(api_key=os.environ.get("TICKETMASTER_API_KEY"))
print(events_fetcher.get_events())